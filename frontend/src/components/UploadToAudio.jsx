...
const voiceOptions = ["alloy", "ash", "coral", "echo", "fable", "onyx", "nova", "sage", "shimmer"];
...
const UploadToPlay = () => {
  ...
  const handleGetAudio = async () => {
    ...
    try {
      const response = await axios.post("http://127.0.0.1:8000/get-audio-gpt/", formData, {
        responseType: "blob", // To handle audio files
      });

      const audioURL = URL.createObjectURL(response.data);
      setAudioFiles([...audioFiles, { id: audioFiles.length + 1, src: audioURL }]);
    ...
    <div style={{ padding: "20px", maxWidth: "600px", margin: "auto" }}>
      ...
      <div>
        <button
          ...
          style={{
            backgroundColor: category === "Presentation" ? "#4CAF50" : "#f1f1f1",
            marginRight: "10px",
          }}
        >
          Presentation
